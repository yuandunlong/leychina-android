 ...
 */
package com.leychina.widget.tabindicator.view.indicator;
...
import com.leychina.widget.tabindicator.view.indicator.slidebar.ScrollBar;
...
public interface Indicator {
	 ...
	 * 设置滑动块<br>
	 * 设置它可以自定义滑动块的样式。<br>
	 * 目前提供的子类 {@link .slidebar.ColorBar}
	 * {@link .slidebar.DrawableBar}
	 * {@link .slidebar.LayoutBar}
	 * 
	 * @param scrollBar
	 */
	 ...
	 * 目前提供的子类
	 * {@link .transition.OnTransitionTextListener}
	 */
